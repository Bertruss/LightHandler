...
private:
	...
	byte range = 5;  // 0-255 variance
	byte midInt = 5; // 0-255 mean instensity
...
public:	
	byte* Brightness;
	LightHandlerSimple(const int *LEDPinArray, const int &NUM_LED);
	LightHandlerSimple();
	void reset();
